...
public class AngularBaseVisitorr extends AngularParserBaseVisitor {
    @Override
    ...
    public Statement visitStatement(AngularParser.StatementContext ctx) {
        if(ctx.variableDeclaration()!=null){
            return  visitInitializedVariableDeclaration(ctx.variableDeclaration());
        }
        else if(ctx.functionDeclaration()!=null){

            return visitFunctionDecl(ctx.functionDeclaration());
        }   else if(ctx.classDeclaration()!=null){
            return visitClassDecl(ctx.classDeclaration());
            ...
            return visitExpressionLable(ctx.expressionStatement());
    ...
    @Override
    public VariableDeclaration visitInitializedVariableDeclaration(AngularParser.VariableDeclarationContext ctx) {
        ...
        if(ctx.expression()!=null){
            variableDeclaration.setExpression(visitConditionalExprLabel(ctx.expression()));
    ...
    @Override
    public FunctionDeclaration visitFunctionDecl(AngularParser.FunctionDeclarationContext ctx) {
    ...
    public Parameter visitParameter(AngularParser.ParameterContext ctx) {
        ...
        if (ctx.expressionStatement() != null){
            parameter.setExpressionStatement(visitExpressionLable(ctx.expressionStatement()));
            return parameter;
        }
    ...
    @Override
    public ClassDeclaration visitClassDecl(AngularParser.ClassDeclarationContext ctx) {
    ...
    public ClassMember visitClassMember(AngularParser.ClassMemberContext ctx) {
        ...
        if(ctx.methodDeclaration()!=null){
            classMember.setMethod(visitMethodDecl(ctx.methodDeclaration()));
            classMember.setIsMethod(true);
        }
        if (ctx.variableDeclaration() != null) {
            classMember.setProperty(true);
            classMember.setVariable(visitInitializedVariableDeclaration(ctx.variableDeclaration()));
        }
        ...
        if (ctx.expressionStatement()!=null){
            classMember.setExpressionStatement(visitExpressionLable(ctx.expressionStatement()));
    ...
    public ObjectMember visitObjectMember(AngularParser.ObjectMemberContext ctx) {
        ...
        if(ctx.expression()!=null){
            objectMember.setExpression(visitConditionalExprLabel(ctx.expression()));
        }
        sympol sympol ;
        boolean add = true ;
    ...
    public AngularCharData visitAngularCharData(AngularParser.AngularCharDataContext ctx) {
        ...
        if(ctx.expressionStatement()!=null){
            angularCharData.setExpressionStatement(visitExpressionLable(ctx.expressionStatement()));
        }
        if (ctx.HTML_TEXT()!=null){
    ...
    @Override
    public MethodDeclaration visitMethodDecl(AngularParser.MethodDeclarationContext ctx) {
    ...
    public EnumMember visitEnumMember(AngularParser.EnumMemberContext ctx) {
        ...
        if(ctx.expression()!=null){
            enumMember.setExpression(visitConditionalExprLabel(ctx.expression()));
        }
        return enumMember;
    }
    ...
    public Statement visitServiceDeclaration(AngularParser.ServiceDeclarationContext ctx) {
        ...
        if(ctx.methodDeclaration()!=null){
            for (int i = 0; i <ctx.methodDeclaration().size() ; i++) {
                serviceDeclaration.getMethodDeclarations().add(visitMethodDecl(ctx.methodDeclaration(i)));
            }
        }
    ...
    public Statement visitExportStatement(AngularParser.ExportStatementContext ctx) {
        ...
        if(ctx.variableDeclaration()!=null){
            ...
            exportStatement.setVariableDeclaration(visitInitializedVariableDeclaration(ctx.variableDeclaration()));
            exportStatement.setExportType("variable");
        }
        if(ctx.classDeclaration()!=null){
            exportStatement.setId(ctx.classDeclaration().ID(0).getText());
            exportStatement.setClassDeclaration(visitClassDecl(ctx.classDeclaration()));
            exportStatement.setExportType("class ");
        }
        if(ctx.functionDeclaration()!=null){
            exportStatement.setId(ctx.functionDeclaration().ID().getText());
            exportStatement.setFunctionDeclaration(visitFunctionDecl(ctx.functionDeclaration()));
    ...
    @Override
    public ExpressionStatement visitExpressionLable(AngularParser.ExpressionStatementContext ctx) {
        ...
        if(ctx.expression()!=null){
            expressionStatement.setExpression(visitConditionalExprLabel(ctx.expression()));
        }
        return  expressionStatement;
    }

    @Override
    public Expression visitConditionalExprLabel(AngularParser.ExpressionContext ctx) {
    ...
    public Expression visitConditionalExpression(AngularParser.ConditionalExpressionContext ctx) {
        ...
        if(ctx.expression(0)!=null){
            conditionalExpression.setTrueExpression(visitConditionalExprLabel(ctx.expression(0)));
        }
        if(ctx.expression(1)!=null){
            conditionalExpression.setFalseExpression(visitConditionalExprLabel(ctx.expression(1)));
        }
    ...
    public Expression visitBinaryExpression(AngularParser.BinaryExpressionContext ctx) {
        ...
        if(ctx.primaryExpression(0)!=null){
            binaryExpression.setLeft(visitIdentifier(ctx.primaryExpression(0)));
        }if(ctx.ASSIGN(0)!=null){
            binaryExpression.setOperator(ctx.ASSIGN(0).getText());
        }
        if(ctx.primaryExpression(1)!=null){
            binaryExpression.setRight(visitIdentifier(ctx.primaryExpression(1)));
        }
        if(ctx.PLUS(0)!=null){
...
//                Main.sympolTable.getSympols().add(sympol);
    ...
    @Override
    public Expression visitIdentifier(AngularParser.PrimaryExpressionContext ctx) {
        ...
        if(ctx.expression()!=null){
            return    visitConditionalExprLabel(ctx.expression());
        }
        ...
        if(ctx.primaryExpression(primaryExpressionTempCount)!=null&&ctx.argumentList()!=null){
            ...
            functionCall.setExpression(visitIdentifier(ctx.primaryExpression(primaryExpressionTempCount)));
        ...
        if(ctx.DOT()!=null && ctx.primaryExpression().size()>=2){
            ...
            dotNotation.setLeft(visitIdentifier(ctx.primaryExpression(primaryExpressionTempCount)));
            primaryExpressionTempCount++;
            dotNotation.setRight(visitIdentifier(ctx.primaryExpression(primaryExpressionTempCount)));
            primaryExpressionTempCount++;
    ...
    public ArgumentList visitArgumentList(AngularParser.ArgumentListContext ctx) {
        ...
        if(ctx.expression()!=null){
            for (int i = 0; i <ctx.expression().size() ; i++) {
                argumentList.getExpressionList().add(visitConditionalExprLabel(ctx.expression(i)));
            }
        }
        return argumentList;
    }
    ...
    public Expression visitAssignmentExpression(AngularParser.AssignmentExpressionContext ctx) {
        ...
        if(ctx.expression()!=null){
            assignmentExpression.setExpression(visitConditionalExprLabel(ctx.expression()));
        }
        if(ctx.ID()!=null){
    ...
    public Statement visitIfStatement(AngularParser.IfStatementContext ctx) {
        ...
        if (ctx.expression() != null) {
            ifStatement.setCondition(visitConditionalExprLabel(ctx.expression()));
        }
    ...
    public Statement visitForStatement(AngularParser.ForStatementContext ctx) {
        ...
        if (ctx.variableDeclaration() != null) {
            forStatement.setVariableDeclaration(visitInitializedVariableDeclaration(ctx.variableDeclaration()));
            ...
            forStatement.setVariableDeclarationAsExpression(visitConditionalExprLabel(ctx.expression(expressionTempCount)));
        ...
        if (ctx.expression(expressionTempCount) != null) {
            forStatement.setCondition(visitConditionalExprLabel(ctx.expression(expressionTempCount)));
        ...
        if (ctx.incrementExpression() != null) {
            ...
            forStatement.setIncrement(visitConditionalExprLabel(ctx.expression(expressionTempCount)));
        ...
        if (ctx.blockStatement() != null) {
            ...
            forStatement.setBody(visitExpressionLable(ctx.expressionStatement()));
        }
    ...
    public ForOf visitForOf(AngularParser.ForOfContext ctx) {
        ...
        if(ctx.variableDeclaration()!=null){
            forOf.setVariableDeclaration(visitInitializedVariableDeclaration(ctx.variableDeclaration()));
        }
        if(ctx.expression()!=null){
            forOf.setExpression(visitConditionalExprLabel(ctx.expression()));
        }
        return forOf;
    }
    ...
    public Statement visitWhileStatement(AngularParser.WhileStatementContext ctx) {
        ...
        if(ctx.expression()!=null){
            whileStatement.setCondition(visitConditionalExprLabel(ctx.expression()));
        }
        if(ctx.statement()!=null){
    ...
    public Statement visitDoWhileStatement(AngularParser.DoWhileStatementContext ctx) {
        ...
        if(ctx.expression()!=null){
            doWhileStatement.setCondition(visitConditionalExprLabel(ctx.expression()));
        }
    ...
    public Statement visitSwitchStatement(AngularParser.SwitchStatementContext ctx) {
        ...
        if (ctx.expression()!=null){
            switchStatement.setExpression(visitConditionalExprLabel(ctx.expression()));
        }
    ...
    public CaseStatement visitCaseStatement(AngularParser.CaseStatementContext ctx) {
        ...
        if(ctx.expression()!=null){
            caseStatement.setCaseExpression(visitConditionalExprLabel(ctx.expression()));
        }
    ...
    public Statement visitReturnStatement(AngularParser.ReturnStatementContext ctx) {
        ...
        if(ctx.expression()!=null){
            returnStatement.setExpression(visitConditionalExprLabel(ctx.expression()));
        }
    ...
    public Statement visitThrowStatement(AngularParser.ThrowStatementContext ctx) {
        ...
        if(ctx.expression()!=null){
            throwStatement.setExpression(visitConditionalExprLabel(ctx.expression()));
        }
